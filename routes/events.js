...
router.post('/create-event', async (req,res) => {
    ...
    const {token, invitedUsers, title, time, date, address, placeId, handiSport,mix, location,privateEvent, sport} = req.body
    ...
    try {
        ...
        const newEvent = new EventModel({
            ...
            location, //will be automatically generated from selected place or will be generated by placed pin ON FRONT
...
router.put('/update-event', async (req,res) => {
    ...
    const {eventId, title, time, date, address, placeId, location, handiSport,mix, privateEvent,invitedUsers,sport} = req.body
    ...
    try {
        ...
        event.place = placeId ? placeId : null
        event.location = location //will be automatically generated from selected place or will be generated by placed pin
